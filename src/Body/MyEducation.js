...
const MyEducation = () => {
  return (
    <Container id="education" fluid style={{ marginTop: "50px" }}>
      ...
      <Row>
        <Col className="fs-4">
          {otherCertificates[1].name}
          <p className="fs-5">
            Score: {otherCertificates[1].score}
            <span className="fs-5">
              {" "}
              <br />
              Quant: {otherCertificates[1].details.Quant} &nbsp; Verbal:{" "}
              {otherCertificates[1].details.Verbal}&nbsp; AWA:{" "}
              {otherCertificates[0].details.AWA}
            </span>
          </p>
        </Col>
      </Row>
